...
var gerar = require('../support/gerarRelatorio.js');
...
module.exports = function () {
    ...
    this.registerHandler('AfterFeatures', function(step, callback) {
        console.log('');
        console.log('');
        console.log('Gerando relatorio html na pasta reports.');
        gerar.gerarRelatorioHtml();
        callback();
    })
